# wp-patomarques
This theme is based in **them.es Starter**, a WordPress Starter Theme built with Bootstrap 5+.

## them.es Starter Theme
[https://them.es/starter-bootstrap](https://them.es/starter-bootstrap)
